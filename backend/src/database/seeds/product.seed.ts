...
const PRODUCTS: Partial<Product>[] = [
  {
    name: 'Capa Silicone iPhone 14 Verde Militar',
    image: 'https://m.media-amazon.com/images/I/51Mmc+VdRML.AC_SY300_SX300_QL70_ML2.jpg',
    priceInCents: 4990,
    stockQuantity: 42,
  },
  {
    name: 'Capa Translúcida Galaxy S23 FE',
